...
class QMTServer:
    ...
    def __init__(self, account_id: str, mini_qmt_path: str, host: str = "127.0.0.1", port: int = 8000, token: Optional[str] = None):
        """
        初始化交易服务器
...
def qmt_server(account_id: str, mini_qmt_path: str, host: str = "127.0.0.1", port: int = 8000, token: Optional[str] = None):
    """
    快速创建并启动服务器的便捷函数
